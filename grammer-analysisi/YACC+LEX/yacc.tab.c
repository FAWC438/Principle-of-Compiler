...
#line 1304 "yacc.tab.c"
  ...
  case 3:
#line 18 "yacc.y"
                                {yyval=yyvsp[-2]+yyvsp[0];printf("\t\t%d -> %d + %d\t\t\tE -> E + T\n",yyval,yyvsp[-2],yyvsp[0]);}
...
#line 1316 "yacc.tab.c"
  ...
  case 5:
#line 20 "yacc.y"
                                        {yyval=yyvsp[0];printf("\t\t%d -> %d\t\t\tE -> T\n",yyval,yyvsp[0]);}
#line 1322 "yacc.tab.c"
    break;

  case 6:
#line 22 "yacc.y"
                                {yyval=yyvsp[-2]*yyvsp[0];printf("\t\t%d -> %d * %d\t\t\tT -> T * F\n",yyval,yyvsp[-2],yyvsp[0]);}
...
#line 1334 "yacc.tab.c"
  ...
  case 8:
#line 24 "yacc.y"
                                        {yyval=yyvsp[0];printf("\t\t%d -> %d\t\t\tT -> F\n",yyval,yyvsp[0]);}
#line 1340 "yacc.tab.c"
    break;

  case 9:
#line 26 "yacc.y"
                                {yyval=yyvsp[-1];printf("\t\t%d -> (%d)\t\t\tF -> (E)\n",yyval,yyvsp[-1]);}
#line 1346 "yacc.tab.c"
    break;

  case 10:
#line 27 "yacc.y"
                                        {yyval=yyvsp[0];printf("\t\t%d -> %d\t\t\tF -> num\n",yyval,yyvsp[0]);}
